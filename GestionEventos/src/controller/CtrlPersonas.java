...
public class CtrlPersonas {
	...
	public static void insPersonas() throws Exception {
		...
		String url = URI + "ins-persona.php?dni=" + view.DlgCreacionPersona.txtDni.getText() + "&" + "nombre="
				+ view.DlgCreacionPersona.txtNombre.getText() + "&" + "apellidos="
				+ view.DlgCreacionPersona.txtApellido.getText() + "&" + "username="
				+ view.DlgCreacionPersona.txtUsername.getText() + "&" + "password=" + sPass + "&" + "correo="
				+ view.DlgCreacionPersona.txtCorreo.getText() + "&" + "telefono="
				+ view.DlgCreacionPersona.txtTelf.getText() + "&" + "rol=" + view.DlgCreacionPersona.txtRol.getText()
	...
	public static void updPersona() {
		...
		try {
			...
			url = URI + "upd-persona.php?dni=" + view.DlgDescripcionPersonas.sDni + "&nombre="
					+ view.DlgDescripcionPersonas.sNombrePersona + "&apellidos="
					+ view.DlgDescripcionPersonas.sApellidosPersona + "&username="
					+ view.DlgDescripcionPersonas.sUsername + "&contrasena=" + view.DlgDescripcionPersonas.sPass
					+ "&correo=" + view.DlgDescripcionPersonas.sCorreo + "&telefono="
					+ view.DlgDescripcionPersonas.sTelefono + "&rol=" + view.DlgDescripcionPersonas.sRol
