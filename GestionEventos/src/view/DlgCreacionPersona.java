...
public class DlgCreacionPersona extends JDialog {
	...
	private void crearComponentes() {
			...
			panelBotones.setBounds(10, 380, 437, 58);
		...
		panelDatos.setBounds(0, 10, 461, 360);
		...
		lblUsername.setBounds(256, 59, 73, 19);
		panelDatos.add(lblUsername);
		
		JLabel lblPassword = new JLabel("Password");
		lblPassword.setFont(new Font("Arial", Font.PLAIN, 12));
		lblPassword.setBounds(256, 97, 73, 16);
		...
		lblNewLabel.setBounds(256, 140, 60, 13);
		...
		txtInformacion.setBounds(28, 259, 416, 85);
